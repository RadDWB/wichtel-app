...
export const AUDIENCES = {
  ...
  adults1840: { label: '🧍 Erwachsene 18-40', value: 'adults1840' },
  adults4060: { label: '🧍 Erwachsene 40-60', value: 'adults4060' },
...
function getSearchKeywords(audience, category) {
  ...
  if (audience === 'adults1840') keywords.push('geschenk erwachsene 18 40');
  if (audience === 'adults4060') keywords.push('geschenk erwachsene 40 60');
  if (audience === 'seniors60') keywords.push('geschenk senioren 60');
