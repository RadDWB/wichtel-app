...
// Flexible Struktur für verschiedene Produktkategorien
...
// Produkt-Kategorien mit Metadaten
export const PRODUCT_CATEGORIES = {
  bluetooth_headphones: {
    id: 'bluetooth_headphones',
...
// Filtere Produkte nach Budget und optionaler Anzahl
export const getProductsByBudget = (maxBudget, category = 'bluetooth_headphones', count = null) => {
  ...
  // Wenn count angegeben, limitiere das Ergebnis
  if (count && count > 0) {
...
export const getAllProductCategories = () => {
  return Object.entries(PRODUCT_CATEGORIES).map(([key, data]) => ({
    id: key,
    name: data.name,
    emoji: data.emoji,
