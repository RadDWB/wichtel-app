...
const CLIENT_ADMIN_PASSWORD = typeof process !== 'undefined' && process.env ? process.env.NEXT_PUBLIC_ADMIN_PASSWORD : undefined;
const SERVER_ADMIN_PASSWORD = typeof process !== 'undefined' && process.env ? process.env.ADMIN_PASSWORD : undefined;

export const ADMIN_PASSWORD = isProduction
  ? (CLIENT_ADMIN_PASSWORD || SERVER_ADMIN_PASSWORD)
  : (CLIENT_ADMIN_PASSWORD || SERVER_ADMIN_PASSWORD || 'admin123'); // Dev fallback only
